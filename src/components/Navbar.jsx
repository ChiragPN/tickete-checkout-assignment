  ...
  return (
    <div>
        <header className='bg-[#F9F9FB40] py-4'>
            <div className='header flex justify-between md:justify-around items-center px-8 w-[100%]'>
                ...
                <div className='h-[22px] w-[73px] flex justify-center items-center space-x-1 text-[#1C2024]'>
